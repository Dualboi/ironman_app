            ...
            <main className="flex-1 w-full px-4 pt-24 md:pt-28">
                <div className="w-full max-w-7xl mx-auto py-6 pb-10 space-y-8">
                    <section className="min-h-[70vh] flex items-center justify-center">
                        <Card title="Complete Your Profile" className="mx-auto" maxWidthClass="max-w-4xl">
                            <p className="text-zinc-400 text-sm mb-6 text-left">A few details so we can personalise your experience. You can change these later in settings.</p>
                            <form className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4 text-left" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 bg-zinc-800 border border-zinc-700 rounded focus:outline-none focus:ring-2 focus:ring-cyan-400 text-zinc-300"
                                    >
