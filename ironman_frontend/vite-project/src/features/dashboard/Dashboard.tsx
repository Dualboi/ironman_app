    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-black via-zinc-900 to-black flex flex-col">
            ...
            <main className="flex-1 w-full px-4 pt-24 md:pt-28">
                <h1 className="w-full text-xl max-w-7xl mx-auto py-6 pb-10 space-y-8 flex items-center justify-center tracking-tight text-center">Ironman training made easy</h1>
