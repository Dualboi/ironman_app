                ...
                <div className="w-full max-w-7xl mx-auto py-6 space-y-6">
                    ...
                    <section>
                        <Card className="text-center">
                            <p className="text-zinc-300 text-xl font-semibold">Welcome to your dashboard, {user?.name}!</p>
                        </Card>
                    </section>
                    <section>
                        <Card className="text-center">
                            <p className="text-zinc-300 text-xl font-semibold">Welcome to your dashboard2 {user?.name}!</p>
                        </Card>
                    </section>
                </div>
            </main>
