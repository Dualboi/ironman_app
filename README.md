...
## This platform once built will be a REST API Web Application capable of creating a Ironman training schedule that is automatically optimised to your needs.
